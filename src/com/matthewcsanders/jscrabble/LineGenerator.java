...
{  
    ...
    public LineGenerator(Dictionary dictionary, LineSplitter lineSplitter, Validator validator)
    {
    ...
    private Collection<String> getWords(String line, Tray tray)
    {
        ...
        for (String word: mValidator.getValid(line, tray))
        {
    ...
    public static void main(String[] args)
    {
        ...
        LineGenerator lg = new LineGenerator(d, ls, new WordValidator(d.getWords()));
